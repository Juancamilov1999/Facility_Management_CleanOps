  ...
  const features = [
    {
      ...
      description:
        'Monitorea todas las actividades de tus contratistas en tiempo real desde cualquier lugar.',
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      title: 'Gestión Centralizada de Contratistas',
      description:
        'Administra múltiples contratistas desde una sola plataforma sin perder el control.',
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        'Recibe notificaciones instantáneas de incidencias o incumplimientos antes de que escalen.',
    },
    {
      icon: (
        <svg
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-dark mb-6">
            Control total de tus operaciones de{' '}
            <span className="text-primary">Facility Management</span>
          </h2>
          <p className="text-lg text-dark-medium max-w-3xl mx-auto">
            Una plataforma diseñada específicamente para Building Owners que
            necesitan supervisar múltiples contratistas y tener visibilidad total.
          </p>
        </motion.div>
        ...
        >
          <p className="text-dark-medium mb-6">
            ¿Listo para tomar el control de tus contratistas?
          </p>
          <a
            href="#demo"
