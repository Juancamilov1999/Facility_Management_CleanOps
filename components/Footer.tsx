      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            >
              <Image
                src="/Logos/Logo CleanOps Blanco.png"
                alt="CleanOps Logo"
                width={180}
                height={54}
          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-dark-medium hover:bg-primary rounded-full flex items-center justify-center transition-all transform hover:scale-110"
                aria-label="LinkedIn"
              >
                <svg
                  className="w-5 h-5"
        ...
        <motion.div
          ...
          className="pt-8 border-t border-dark-medium"
        >
